    ...
    <div id="egc-calculator-container" className="p-6 max-w-7xl mx-auto space-y-8 bg-slate-50 dark:bg-slate-900 rounded-2xl transition-colors duration-200">
      ...
      <div id="egc-header" className="flex flex-col md:flex-row md:items-center md:justify-between pb-6 border-b border-slate-200 dark:border-slate-800 gap-4">
        ...
        <div id="egc-exports-group" className="flex flex-wrap items-center gap-2.5">
          <button
            id="btn-export-pdf"
            onClick={() => exportEgcToPdf(activeOcpd, material, egcResult)}
            className="flex items-center gap-2 px-3.5 py-2 text-xs font-semibold rounded-lg bg-red-50 hover:bg-red-100 text-red-600 dark:bg-red-950/40 dark:hover:bg-red-950/60 dark:text-red-400 border border-red-200/40 dark:border-red-900/30 transition-all cursor-pointer shadow-sm"
          >
          ...
          <button
            id="btn-export-docx"
            onClick={() => exportEgcToWord(activeOcpd, material, egcResult)}
            className="flex items-center gap-2 px-3.5 py-2 text-xs font-semibold rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-600 dark:bg-blue-950/40 dark:hover:bg-blue-950/60 dark:text-blue-400 border border-blue-200/40 dark:border-blue-900/30 transition-all cursor-pointer shadow-sm"
          >
