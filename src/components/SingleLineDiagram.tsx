...
export const SingleLineDiagram: React.FC<SingleLineDiagramProps> = ({ panel, mainFeeder, panelRows, formatWireSize, isSubPanel }) => {
  ...
  return (
    <div className="w-full flex justify-center bg-white border-2 border-slate-800 p-8">
      ...
      >
        <defs>
          <marker id="arrowheadLeft" markerWidth="10" markerHeight="10" refX="0" refY="5" orient="auto-start-reverse">
            <polygon points="0,5 10,0 10,10" fill="#1e293b" />
          </marker>
          <marker id="arrowheadRight" markerWidth="10" markerHeight="10" refX="10" refY="5" orient="auto">
